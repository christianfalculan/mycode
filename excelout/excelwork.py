...
def get_ip_data():
    ...
    input_MAC = input("What is the MAC_Address?")
    input_location = input("Where are you located?")
    d = {"IP": input_ip, "driver": input_driver, "MAC": input_MAC, "location": input_location}
    return d
